...
2. **Edit a reminder:** Click the "Edit" button on any reminder
3. **Mark as complete:** Click "Mark Complete" - recurring reminders will automatically advance to the next due date
4. **Delete a reminder:** Click "Delete" and confirm
5. **Filter reminders:** Use the search box or category dropdown
6. **Dismiss notifications:** Click "Dismiss" on any notification (the reminder stays active)
